var longitudeGtc = (function (exports, msfsSdk, msfsWtg3000Gtc, msfsGarminsdk, msfsWtg3000Common) {
    'use strict';
     ...
     */
    class LongitudeGtcCssPlugin extends msfsWtg3000Gtc.AbstractG3000GtcPlugin {
        /** @inheritdoc */
        onInstalled() {
     ...
     */
    class LongitudeExteriorLightsPage extends msfsWtg3000Gtc.GtcView {
        constructor() {
            super(...arguments);
        ...
        render() {
            return (msfsSdk.FSComponent.buildComponent("div", { class: 'lng-lights-page' },
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-light-page-row' },
                    ...
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'On', state: this.navSetting, onPressed: () => this.navSetting.set(true) }),
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'Off', state: this.navOffState, onPressed: () => this.navSetting.set(false) })),
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-light-page-row three-button' },
                    ...
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'Normal', state: this.beaconNormState, onPressed: () => this.beaconSetting.set(BeaconLightsMode.Normal) }),
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'On', state: this.beaconOnState, onPressed: () => this.beaconSetting.set(BeaconLightsMode.On) }),
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'Off', state: this.beaconOffState, onPressed: () => this.beaconSetting.set(BeaconLightsMode.Off) })),
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-light-page-row' },
                    msfsSdk.FSComponent.buildComponent("label", null, "Pulse With TCAS TA/RA"),
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'On', state: this.pulseSetting, onPressed: () => this.pulseSetting.set(true) }),
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'Off', state: this.pulseOffState, onPressed: () => this.pulseSetting.set(false) }))));
        }
        /** @inheritdoc */
        destroy() {
     ...
     */
    class LongitudePressurizationPage extends msfsWtg3000Gtc.GtcView {
        constructor() {
            super(...arguments);
            ...
            this.altitudeUnitsSetting = msfsGarminsdk.UnitsUserSettings.getManager(this.props.bus).getSetting('unitsAltitude');
        ...
        render() {
            return (msfsSdk.FSComponent.buildComponent("div", { class: 'lng-press-page' },
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-press-page-mode lng-press-page-group' },
                    ...
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'Normal', ref: this.normalButton, state: this.normalState, onPressed: () => this.cabinAltitudeModeSetting.set(this.normalMode) }),
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'Altitude<br>Select', ref: this.altitudeSelectButton, state: this.altitudeSelectState, onPressed: () => this.cabinAltitudeModeSetting.set(CabinAltitudeMode.CabinAlt) })),
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-press-page-alt lng-press-page-group' },
                    ...
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcTouchButton, { ref: this.altitudeButton, label: this.renderAltButtonLabel(), onPressed: this.onAltButtonPressed.bind(this) }))));
        }
        /**
        ...
        async selectLandingElevation() {
            ...
            const result = await this.gtcService.openPopup(LongitudeGtcKeys.LandingElevationDialog, 'normal', 'darken')
                ...
                unitsMode: this.altitudeUnitsSetting.value === msfsGarminsdk.UnitsAltitudeSettingMode.Meters || this.altitudeUnitsSetting.value === msfsGarminsdk.UnitsAltitudeSettingMode.MetersMps
                    ? 'meters' : 'feet'
            });
        ...
        renderAltButtonLabel() {
            return (msfsSdk.FSComponent.buildComponent("div", { class: 'lng-press-alt-button-label' },
                msfsSdk.FSComponent.buildComponent("div", { class: this.displayedAltitudeClass },
                    msfsSdk.FSComponent.buildComponent(msfsGarminsdk.NumberUnitDisplay, { value: this.displayedAltitude, formatter: LongitudePressurizationPage.ALTITUDE_FORMATTER, displayUnit: msfsSdk.UnitType.FOOT })),
     ...
     */
    class LongitudePropulsionPage extends msfsWtg3000Gtc.GtcView {
        constructor() {
            super(...arguments);
        ...
        render() {
            return (msfsSdk.FSComponent.buildComponent("div", { class: 'lng-prop-page' },
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-prop-page-left' },
                    ...
                    msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { class: 'lng-prop-page-digitsbutton', label: 'Display<br>Engine Digits', state: this.settings.getSetting('ittEngineDigits') })),
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-prop-page-right' },
                    ...
                    msfsSdk.FSComponent.buildComponent("div", { class: 'lng-prop-page-engine-ign lng-prop-page-group' },
                        ...
                        msfsSdk.FSComponent.buildComponent("div", { class: 'lng-prop-page-engine-ign-buttoncontainer' },
                            msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcSetValueTouchButton, { label: 'Normal', state: this.settings.getSetting('engineIgnitorsSetOn'), setValue: false }),
                            msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcSetValueTouchButton, { label: 'On', state: this.settings.getSetting('engineIgnitorsSetOn'), setValue: true }))))));
        }
        /** @inheritdoc */
        destroy() {
            var _a;
     ...
     */
    class LongitudeSystemsPage extends msfsWtg3000Gtc.GtcView {
        /**
        ...
        constructor(props) {
            ...
            this.displayPaneSettingManager = msfsWtg3000Common.DisplayPanesUserSettings.getDisplayPaneManager(this.bus, this.props.displayPaneIndex);
        }
        /** @inheritdoc */
        onAfterRender() {
        ...
        renderTab(position, label, renderContent) {
            ...
            return (msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.TabbedContent, { position: position, label: label, onPause: () => {
            ...
            return (msfsSdk.FSComponent.buildComponent(SystemsPageTabContent, { ref: ref },
                msfsSdk.FSComponent.buildComponent("div", { class: 'longitude-systems-page-tabcontent' },
                    msfsSdk.FSComponent.buildComponent("div", { class: 'longitude-systems-icon-row' },
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'Cabin<br>Management', imgSrc: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_cabin.png', isEnabled: false, class: 'gtc-directory-button cabin-management' }),
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'Temp', imgSrc: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_small_ecs.png', isEnabled: true, class: 'gtc-directory-button', onPressed: () => this.gtcService.changePageTo(LongitudeGtcKeys.Temp) }),
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'Cabin<br>Pressure', imgSrc: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_small_cabin_pressure.png', isEnabled: true, class: 'gtc-directory-button', onPressed: () => this.gtcService.changePageTo(LongitudeGtcKeys.CabinPressure) })),
                    msfsSdk.FSComponent.buildComponent("div", { class: 'longitude-systems-icon-row' },
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'Exterior<br>Lights', imgSrc: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_external_lighting.png', isEnabled: true, class: 'gtc-directory-button', onPressed: () => this.gtcService.changePageTo(LongitudeGtcKeys.ExteriorLights) }),
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'Propulsion', imgSrc: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_small_systems_turbine.png', isEnabled: true, class: 'gtc-directory-button', onPressed: () => this.gtcService.changePageTo(LongitudeGtcKeys.Propulsion) }),
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'Stall<br>Schedule', isEnabled: false, class: 'gtc-directory-button' })),
                    msfsSdk.FSComponent.buildComponent("div", { class: 'longitude-systems-icon-row' },
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'System<br>Tests', imgSrc: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_self_test.png', isEnabled: false, class: 'gtc-directory-button' }),
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'Alert<br>Suppression', isEnabled: false, class: 'gtc-directory-button' }),
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcImgTouchButton, { label: 'Maintenance', imgSrc: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_small_maintenance.png', isEnabled: false, class: 'gtc-directory-button maintenance' })))));
        }
        /**
         * Renders the Controls tab.
         * @param ref The reference to assign to the tab content.
        ...
        render() {
            return (msfsSdk.FSComponent.buildComponent("div", { class: 'longitude-systems-page' },
                msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.TabbedContainer, { ref: this.tabContainerRef, configuration: msfsWtg3000Gtc.TabConfiguration.Left5, class: 'longitude-systems-page-tabs' },
     ...
     */
    class LongitudeTemperaturePage extends msfsWtg3000Gtc.GtcView {
        constructor() {
            super(...arguments);
            ...
            return (msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-page-container' },
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-page-row' },
                    msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-page-cockpitbuttons' },
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcListSelectTouchButton, { label: 'Recirc Fan', state: this.recircFanState, gtcService: this.gtcService, listDialogKey: msfsWtg3000Gtc.GtcViewKeys.ListDialog1, listParams: {
                    ...
                    msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-group touch-button' },
                        ...
                        msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-slider' },
                            msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcTouchButton, { onPressed: () => this.changeTemp(this.cockpitTemp, this.cockpitSliderState, this.cockpitTemp.get() - 1) },
                            ...
                            msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.TouchSlider, { bus: this.bus, orientation: 'to-right', state: this.cockpitSliderState, onValueChanged: (val) => this.changeTemp(this.cockpitTemp, this.cockpitSliderState, this.sliderToTemp(val)), changeValueOnDrag: true, lockFocusOnDrag: true, stops: this.currentStops, foreground: msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-slider-bar' }), background: msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-slider-bar' }), thumb: msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcSliderThumbIcon, { sliderOrientation: 'horizontal' }) }),
                            msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcTouchButton, { onPressed: () => this.changeTemp(this.cockpitTemp, this.cockpitSliderState, this.cockpitTemp.get() + 1) },
                ...
                msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-page-row' },
                    msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-page-cabinbuttons' },
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcToggleTouchButton, { label: 'Cabin<br>Control', state: this.cabinControl, isEnabled: false, class: 'lng-temp-page-cabin-control-button' }),
                        msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcValueTouchButton, { label: 'Units', state: this.tempUnits, renderValue: (v) => v === EcsTemperatureUnits.Celsius ? '°C' : '°F', onPressed: this.toggleUnits.bind(this), class: 'lng-temp-page-units-button' })),
                    msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-group touch-button' },
                        msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-group-label' }, "Cabin"),
                        msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-slider' },
                            msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcTouchButton, { onPressed: () => this.changeTemp(this.cabinTemp, this.cabinSliderState, this.cabinTemp.get() - 1) },
                                msfsSdk.FSComponent.buildComponent("img", { src: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_minus_left.png' })),
                            msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.TouchSlider, { bus: this.bus, orientation: 'to-right', state: this.cabinSliderState, onValueChanged: (val) => this.changeTemp(this.cabinTemp, this.cabinSliderState, this.sliderToTemp(val)), changeValueOnDrag: true, lockFocusOnDrag: true, stops: this.currentStops, foreground: msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-slider-bar' }), background: msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-slider-bar' }), thumb: msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcSliderThumbIcon, { sliderOrientation: 'horizontal' }) }),
                            msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcTouchButton, { onPressed: () => this.changeTemp(this.cabinTemp, this.cabinSliderState, this.cabinTemp.get() + 1) },
                                msfsSdk.FSComponent.buildComponent("img", { src: 'coui://html_ui/Pages/VCockpit/Instruments/NavSystems/WTG3000/Assets/Images/GTC/icon_plus_right.png' }))),
                        msfsSdk.FSComponent.buildComponent("div", { class: 'lng-temp-displays' },
    ...
    class TempDisplay extends msfsSdk.DisplayComponent {
        ...
        render() {
            ...
            return (msfsSdk.FSComponent.buildComponent("div", { class: `lng-temp-temp-display ${(_a = this.props.class) !== null && _a !== void 0 ? _a : ''}` },
                ...
                msfsSdk.FSComponent.buildComponent(msfsGarminsdk.NumberUnitDisplay, { ref: this.displayRef, value: this.value, displayUnit: this.unit, formatter: TempDisplay.FORMATTER })));
        }
        /** @inheritdoc */
        destroy() {
            var _a, _b;
     ...
     */
    class LongitudeSystemsPlugin extends msfsWtg3000Gtc.AbstractG3000GtcPlugin {
        /** @inheritdoc */
        registerGtcViews(gtcService) {
            gtcService.registerView(msfsWtg3000Gtc.GtcViewLifecyclePolicy.Transient, msfsWtg3000Gtc.GtcViewKeys.AircraftSystems, 'MFD', (service, mode, index) => msfsSdk.FSComponent.buildComponent(LongitudeSystemsPage, { gtcService: service, controlMode: mode, displayPaneIndex: index }));
            gtcService.registerView(msfsWtg3000Gtc.GtcViewLifecyclePolicy.Transient, LongitudeGtcKeys.Temp, 'MFD', (service, mode, index) => msfsSdk.FSComponent.buildComponent(LongitudeTemperaturePage, { gtcService: service, controlMode: mode, displayPaneIndex: index }));
            gtcService.registerView(msfsWtg3000Gtc.GtcViewLifecyclePolicy.Transient, LongitudeGtcKeys.Propulsion, 'MFD', (service, mode, index) => msfsSdk.FSComponent.buildComponent(LongitudePropulsionPage, { gtcService: service, controlMode: mode, displayPaneIndex: index }));
            gtcService.registerView(msfsWtg3000Gtc.GtcViewLifecyclePolicy.Transient, LongitudeGtcKeys.ExteriorLights, 'MFD', (service, mode, index) => msfsSdk.FSComponent.buildComponent(LongitudeExteriorLightsPage, { gtcService: service, controlMode: mode, displayPaneIndex: index }));
            gtcService.registerView(msfsWtg3000Gtc.GtcViewLifecyclePolicy.Transient, LongitudeGtcKeys.CabinPressure, 'MFD', (service, mode, index) => {
            ...
            gtcService.registerView(msfsWtg3000Gtc.GtcViewLifecyclePolicy.Transient, LongitudeGtcKeys.LandingElevationDialog, 'MFD', (service, mode, index) => msfsSdk.FSComponent.buildComponent(msfsWtg3000Gtc.GtcPressurizationDialog, { gtcService: service, controlMode: mode, displayPaneIndex: index }));
        }
    }
